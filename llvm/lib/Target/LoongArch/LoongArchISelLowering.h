...
enum NodeType : unsigned {
  ...
  SplitF64,
  TAIL,
  // LA64 shifts, directly matching the semantics of the named RISC-V
  // instructions.
  SLLW,
  SRAW,
  SRLW,
  // 32-bit operations from LA64 that can't be simply matched with a pattern
  ...
  DIVUW,
  REMUW,
  // LA64 rotates, directly matching the semantics of the named RISC-V
  // instructions.
  ROLW,
  RORW,
  ...
  // FMV_W_X_LA64 matches the semantics of the FMV.W.X.
  // FMV_X_ANYEXTW_LA64 is similar to FMV.X.W but has an any-extended result.
  //
...
private:
  ...
  SDValue getStaticTLSAddr(GlobalAddressSDNode *N, SelectionDAG &DAG,
                           bool UseGOT) const;
  SDValue getDynamicTLSAddr(GlobalAddressSDNode *N, SelectionDAG &DAG, bool Global) const;
...
struct LoongArchVIntrinsicInfo {
...
#define GET_LoongArchVIntrinsicsTable_DECL
#include "LoongArchGenSearchableTables.inc"

} // end namespace LoongArchVIntrinsicsTable

namespace LoongArchZvlssegTable {

struct LoongArchZvlsseg {
  unsigned int IntrinsicID;
  unsigned int SEW;
  unsigned int LMUL;
...
#define GET_LoongArchZvlssegTable_DECL
#include "LoongArchGenSearchableTables.inc"
