//=- LoongArchMachineFunctionInfo.h - LoongArch machine function info -----*- C++ -*-=//
//
...
/// LoongArchMachineFunctionInfo - This class is derived from MachineFunctionInfo
/// and contains private LoongArch-specific information for each MachineFunction.
